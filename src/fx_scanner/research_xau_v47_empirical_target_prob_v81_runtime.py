...
from .research_xau_v47_empirical_target_prob_v81 import (
    ARTIFACT_CONTRACT,
    FULL_END,
    FULL_START,
    RESEARCH_VERSION,
...
UTC = timezone.utc
WORKER_NAME = "dukascopy_xau_v47_empirical_target_prob_v81"
FULL_ERA = {
...
def run() -> int:
    ...
    path = Path(os.getenv("V81_EVIDENCE_OUTPUT", "artifacts/xau-v47-empirical-target-prob-v81.json"))
