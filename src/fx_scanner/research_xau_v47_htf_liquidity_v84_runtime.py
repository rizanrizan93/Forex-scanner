...
from .research_xau_v47_htf_liquidity_v84 import (
    ARTIFACT_CONTRACT,
    FULL_END,
    FULL_START,
    RESEARCH_VERSION,
...
UTC = timezone.utc
WORKER_NAME = "dukascopy_xau_v47_htf_liquidity_v84"
FULL_ERA = {
...
def run() -> int:
    ...
    path = Path(os.getenv("V84_EVIDENCE_OUTPUT", "artifacts/xau-v47-htf-liquidity-v84.json"))
