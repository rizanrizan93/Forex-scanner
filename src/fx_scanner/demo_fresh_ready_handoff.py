...
def load_demo_execution_policy(root=None) -> ExecutionPolicy:
    ...
    The Auto workflow may opt into up to ten total positions. Every new order is
    hard-capped at 0.01 lot; same-symbol stacking remains conditional and each
    signal must independently qualify. LIVE remains untouched.
    """
