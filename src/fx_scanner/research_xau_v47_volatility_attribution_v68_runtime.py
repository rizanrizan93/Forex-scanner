...
from .research_xau_v47_volatility_attribution_v68 import (
    ARTIFACT_CONTRACT,
    FULL_END,
    FULL_START,
    RESEARCH_VERSION,
...
UTC = timezone.utc
WORKER_NAME = "dukascopy_xau_v47_volatility_attribution_v68"
FULL_ERA = {
...
def run() -> int:
    ...
    path = Path(os.getenv("V68_EVIDENCE_OUTPUT", "artifacts/xau-v47-volatility-attribution-v68.json"))
