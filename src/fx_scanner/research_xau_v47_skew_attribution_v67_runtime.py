...
from .research_xau_v47_skew_attribution_v67 import (
    ARTIFACT_CONTRACT,
    FULL_END,
    FULL_START,
    RESEARCH_VERSION,
...
UTC = timezone.utc
WORKER_NAME = "dukascopy_xau_v47_skew_attribution_v67"
FULL_ERA = {
...
def run() -> int:
    ...
    path = Path(os.getenv("V67_EVIDENCE_OUTPUT", "artifacts/xau-v47-skew-attribution-v67.json"))
