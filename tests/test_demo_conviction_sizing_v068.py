...
def test_conviction_sizing_uses_full_user_approved_lot_range():
    cases = (
        (_row(55.0), "BASE", 0.01, 0.5),
        (_row(65.0), "B", 0.02, 1.0),
        (_row(75.0, 0.90, 2.0), "B_PLUS", 0.03, 1.5),
        (_row(85.0, 0.95, 2.2), "A", 0.05, 2.0),
        (_row(92.0, 0.92, 2.2), "A_PLUS", 0.07, 2.5),
