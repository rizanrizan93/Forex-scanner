...
def test_conviction_sizing_scales_lots_by_quality_tier():
    cases = (
        ...
        (_row(75.0, 0.90, 2.0), "B_PLUS", 0.02, 2.0),
        (_row(85.0, 0.95, 2.2), "A", 0.04, 3.0),
        (_row(92.0, 0.92, 2.2), "A_PLUS", 0.06, 4.0),
        (_row(97.0, 0.97, 3.0), "ELITE", 0.10, 5.0),
    )
...
def test_fast_handoff_installs_bounded_demo_conviction_sizing():
    ...
    assert "DEMO_ORDER_LOT_CAP_CEILING = 0.10" in source
