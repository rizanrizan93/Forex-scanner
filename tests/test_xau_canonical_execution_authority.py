...
from fx_scanner.demo_xau_v24_champion_candidate_producer import STRATEGY_ID as V24_STRATEGY_ID
...
def test_broker_critical_xau_path_precedes_all_shadow_producers():
    ...
    champion = text.index("demo_xau_v24_champion_candidate_producer")
    ...
    assert repair < champion < handoff < manager
